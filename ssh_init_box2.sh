...
docker run --name postgresqldb -e POSTGRES_USER=pguser -e POSTGRES_PASSWORD=securepassword -p 5432:5432 -v /pool/pg_dataset:/var/lib/postgresql/data -d postgres
printf "=======\n"
...
export PGPASSWORD='securepassword' && psql -h box2 -p 5432 -U pguser -c "create database world" && psql -h box2 -p 5432 -U pguser world < dbsamples-0.1/world/world.sql
